      ...
      <div className="section-container">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative">
            ...
            {education.map((item, index) => <div key={index} className={`relative flex flex-col md:flex-row gap-6 md:gap-12 mb-12 opacity-0 animate-fade-in`} style={{
            animationDelay: `${0.2 + index * 0.15}s`
                ...
                <div className={`ml-12 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12 md:ml-auto'}`}>
                  <div className="p-6 rounded-xl bg-card card-hover border border-border">
                    ...
                    <h3 className="text-xl font-semibold mb-1 text-secondary-foreground">{item.degree}</h3>
